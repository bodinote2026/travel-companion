...
- **GitHub:** https://github.com/bodinote2026/travel-companion
- **묵호 MVP (companion):** Vercel Root Directory `apps/companion`, `main` push 시 자동 배포
- **레거시 웹 (apps/web):** 별도 Vercel 프로젝트 설정 시 해당 Root Directory 사용
